    ...
    <div className="relative min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto mb-8">
          <div className="bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-gray-200">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-linear-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  {userName.charAt(0) || "U"}
                </div>
                <div>
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">
                    Welcome back, <span className="text-transparent bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text">{userName}</span>! 👋
                  </h1>
              ...
              <div className="w-full sm:w-auto">
                <div className="bg-white/90 border border-gray-200 rounded-xl p-4 shadow flex flex-col gap-2 min-w-[280px]">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-800 text-xs truncate max-w-40">{userEmail}</span>
                  </div>
                  <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
              ...
              <button
                ...
                className="w-full bg-linear-to-r from-green-500 to-emerald-500 text-white py-2 rounded-lg font-semibold hover:from-green-600 hover:to-emerald-600 transition-all duration-300"
              >
                Start Assessment
              </button>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
              ...
              <button
                ...
                className="w-full bg-linear-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
              >
                Chat Now
              </button>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-gray-200">
            <div className="text-center">
              <p className="text-gray-600 text-sm mb-2">
                Powered by <span className="font-semibold text-transparent bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text">AI Intelligence</span>
              </p>
